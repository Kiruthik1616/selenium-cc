...
public class ccnew {
	public static void main( String[] args ) throws InterruptedException
    {
        ...
        driver.findElement(By.xpath("//*[@id=\"first-name\"]")).sendKeys("KIRUTHIK ");
        driver.findElement(By.xpath("//*[@id=\"last-name\"]")).sendKeys("KB");
        driver.findElement(By.xpath("//*[@id=\"postal-code\"]")).sendKeys("641004");
